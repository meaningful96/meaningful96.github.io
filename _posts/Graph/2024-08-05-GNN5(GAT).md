...
## 2. "Attention"이란?
어텐션(Attention)은 2017년 구글에서 발표한 [트랜스포머(Transformer)](https://meaningful96.github.io/nr/01-Transformer/) 이후로 여러 AI 분야에서 보편적으로 사용되고 있는 테크닉이다. 어텐션은 **입력으로 들어온 여러 데이터들에 대해 서로 간의 "중요도"를 계산**하는 것이다. 수많은 정보가 산재해 있을 때
