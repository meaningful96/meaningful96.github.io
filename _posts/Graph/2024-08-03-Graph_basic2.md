...
- **Transductive**
  - 학습 결과: <span style="color:#9e0000">**노드 임베딩**</span> $$z_v$$
  - 학습 중 보지 못한 정점(Unseen node)에 대한 임베딩을 생성하지 못한다.

- **Inductive**
  - 학습 결과: <span style="color:#9e0000">**Encoder**</span>(= function)
