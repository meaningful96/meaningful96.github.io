...
```
  ...
  **<span style = "color:aqua">결국 데이터들이 각 레이어에서 0과 1에 집중되어있고, 다음 Layer로 Sigmoid를 취해서 넘어갈 경우 결국 미분값은 0됨을 알 수 있다.</span>**
...
**<span style = "color:aqua">Important</span>**  
```
...
**<span style = "color:aqua">How to reduce distortion</span>** 
```
