...
<figure style="text-align: center; margin: auto;">
  <img width="1000" alt="1" src="https://github.com/user-attachments/assets/7530d7ff-6b5b-4450-bc04-d752935beb40" style="display: block; margin: auto;">
...
### 5) MPRC
<figure style="text-align: center; margin: auto;">
  <img width="1000" alt="1" src="" style="display: block; margin: auto;">
  <figcaption style="font-size:70%; text-align: center; width: 100%; margin-top: 0px;">
...
**RTE**는 **Recognizing Textual Entailment**의 약자로, 연례 텍스트 함의 챌린지(annual textual entailment challenge)에서 가져온 데이터를 사용한다. 이 태스크는 MNLI와 유사하지만, **Neutral**과 **Contradiction** 라벨을 **Not-Entailment**로 합쳐 <span style="color:red">**이진 분류 태스크**</span>로 구성된 것이 특징이다.
...
### 7) CoLA
<figure style="text-align: center; margin: auto;">
  <img width="1000" alt="1" src="https://github.com/user-attachments/assets/4c722c44-ef97-44d9-9471-4accc79c414f" style="display: block; margin: auto;">
  <figcaption style="font-size:70%; text-align: center; width: 100%; margin-top: 0px;">
    <em>ref) [3] Neural Network Acceptability Judgements (Warstadt et al., 2018)</em>
  </figcaption>
</figure>

CoLA는 2. Single sentence classification에 속하는 태스크로, The Corpus of Linguistic Acceptability약자이다. 이는 "언어학적으로 수용 가능한 문장인지" 판별하는 태스크이다. 이 태스크는 수용 가능한지 아닌지를 판별하기 때문에 **이진 분류(Binary Classification)**에 해당한다. 평가 지표는 Matthews Correlation Coefficient(MCC)를 사용한다.
...
### 8) SST-2
<figure style="text-align: center; margin: auto;">
  <img width="1000" alt="1" src="https://github.com/user-attachments/assets/2eee3007-ede1-46ee-a079-1def80187cd7" style="display: block; margin: auto;">
  <figcaption style="font-size:70%; text-align: center; width: 100%; margin-top: 0px;">
    <em>ref) [4] github.com/pilsung-kang</em>
  </figcaption>
</figure>
# BLEU(Bilingual Evaluation Understudy) Score
The Stanford Sentiment Treebank의 약자로, 영화 리뷰와 그에 따른 긍정(positive)/부정(negative) 라벨링이 붙어 있는 데이터이다. 태스크는 문장이 주어지면 감성 분석을 통하여 문장의 긍정/부정 여부를 class로 구분하여 이진분류하는 태스크이다.
...
\[4\] [github.com/pilsung-kang](https://github.com/pilsung-kang/Text-Analytics)  
