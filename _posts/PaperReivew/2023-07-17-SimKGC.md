...
additive margin $$\gamma$$는 0보다 크면( $$\gamma \; > \; 0$$, 양수)이면 모델이 정답 Triple ($$h,r,t$$)의 점수, Score를 증가하게 유도한다. Loss식에서 $$\phi (h,r,t)$$ 후보 Triple의 Score function이며 앞서 정의했듯, 이 Score function $$\phi (h,r,t) \; = \; cos(e_{hr}, e_t)$$가 된다.
