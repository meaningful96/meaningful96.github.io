...
<center><span style = "font-size:120%">$$\matchbb{E}[d] = \frac{2M}{N} \rightarrow \mathbb{E}_{L(\mathcal(G))} = \frac{N \cdot \mathsf{Var}_{\mathcal{G}}[d]}{M} + \frac{4M}{N} - 2$$</span></center>
...
<center><span style = "font-size:120%">$$edges \; in \; L(\mathcal{G}) = \diplaystylsum_i \begin{pmatrix}  d_i\\ 2 \\\end{pmatrix}$$</span></center>
