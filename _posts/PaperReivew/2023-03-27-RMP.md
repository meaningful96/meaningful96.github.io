...
Aggregation은 총 **M번** 진행된다. 그리고 각각의 aggregation은 $$ \mathbb{E_{L(\mathcal{G})}}[d] = \frac{N \cdot \mathsf{Var_{\mathcal{G}}}[d]}{M} + \frac{4M}{N} - 2$$ Element들을 예상 입력으로 한다. 따라서 $$ M \cdot \mathbb{E_{L(\mathcal{G})}}[d] = N \cdot \mathsf{Var_{\mathcal{G}}}[d] + \frac{4M^2}{N} - 2M$$
