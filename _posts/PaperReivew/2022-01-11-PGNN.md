...
**Small set**으로 sampling하면 좀 더 <span style = "color:aqua">Specific한 subgraph를 표현하기에 그 만큼 Position을 표현하기에 유용</span>하지만, <span style = "color:magenta">자칫 기준점으로부터 거리가 너무 멀어질 수 있다.</span>

**Large set**의 경우는 <span style = "color:aqua">노드간의 계산을 할 수 있으나</span> <span stlye = "color:magenta">노드의 Position을 설명하는 파워는 줄어듭니다.</span> 따라서, Position과 Set의 크기는 Trade-off 관계에 있습니다.
