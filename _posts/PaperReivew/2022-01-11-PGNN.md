...
**Large set**의 경우는 <span style = "color:aqua">노드간의 계산을 할 수 있으나</span> <span stlye = "color:orange">노드의 Position을 설명하는 파워는 줄어듭니다.</span> 따라서, Position과 Set의 크기는 Trade-off 관계에 있습니다.
