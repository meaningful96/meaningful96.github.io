---
title: "[논문리뷰]Fact Embedding through Diffusion Model for Knowledge Graph Completion(WWW, 2024)"
...
**2. reverse diffusion process**
  - Reverse 과정에서는 훈련된 조건부 사실 노이즈 제거기를 사용하여 가우시안 분포에서 벡터 공간 내 타당한 사실의 분포로 <span style="color:#9e0000">**마르코프 전이(Markov Transition)**</span>를 모델링한다.
