...
<p align="center">
<img width="600" alt="1" src="https://github.com/meaningful96/Deep_Learning/assets/111734605/4a069cf1-f63d-4e64-b794-92375b659dcd">
</p>

Self-attention을 활용하는 트랜스포머 자체도 강력하다. 논문에서도 트랜스포머에 "<span style="color:gold">어떻게 정보를 취합할 것인가?</span>"에 대한 가이드라인을 제공함으로써 성능 향상을 이끌어 냈다. 공동 추론을 위해 학습 가능한 상대 위치 편향 $$\ohm$$(relative position bias)를 도입한다. 이는 연관된 토큰들 사이의 cross-modal attention weight을 제어하는 역할을 한다.
