---
title: "[논문리뷰]Structure Aware Negative Sampling in Knowledge Graphs(EMNLP, 2020)"
...
k-hop 텐서가 3000개의 random walf로 잘 근사될 뿐만 아니라, RW-SANS가 두 가지 baseline을 모두 압도한다는 것이다. 이는 특정 엔티티가 중심 엔티티와 더 많은 경로를 공유하며 샘플링될 확률이 높아지기 때문에, 암묵적으로 <span style="color:#9e0000">**weighted negative sampling**</span> 체계가 형성되기 때문이다.
