...
이 때, <b>$$e^{-}_{t_j}$$</b>는 negative tail $$t_j^{-}$$의 임베딩이다. 기존의 연구들을 통해 **InfoNCE loss**는 *log Bayesian* 모델과 동일하다. 따라서 아래와 같이 loss식을 정의할 수 있다. $$\mathcal{T}_{batch} \subseteq \mathcal{T}$$이며, $$\#(t)$$가   $$\mathcal{T}_{batch}$$에서 발생한 횟수를 의미한다.

<p align="center">
<img width="400" alt="1" src="https://github.com/meaningful96/Paper_Reconstruction/assets/111734605/d3abc5c7-149f-4561-9169-eddee2a71c42">
</p>
...
<p align="center">
<img width="400" alt="1" src="https://github.com/meaningful96/Paper_Reconstruction/assets/111734605/9b675077-933d-4b06-9ca1-d811c29376ae">
</p>
