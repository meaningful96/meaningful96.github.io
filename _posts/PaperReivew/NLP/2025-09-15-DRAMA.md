...
이를 해결하기 위해, 이 논문에서는 i) <span style="color:gold">**retriever를 학습하기 위한 데이터를 LLM을 통해 augment**</span>하는 방법과, ii) <span style="color:gold">**LLM을 pruning하여 retriever의 backbone으로 활용**</span>하는 방법을 제시한다.
