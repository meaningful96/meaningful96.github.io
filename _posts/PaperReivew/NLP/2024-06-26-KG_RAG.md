...
모델은 크게 <span style="color:gold">**1)Storage**</span>, <span style="color:gold">**2)Retrieval**</span>, <span style="color:gold">**3)Answer Generation**</span>의 세 부분으로 구성된다.
...
논문에서는 트리플을 $$t = (e, r, e^{'})$$로 표현하고, 위의 문장과 같이 텍스트 청크를 $$T$$로 표현한다. 
