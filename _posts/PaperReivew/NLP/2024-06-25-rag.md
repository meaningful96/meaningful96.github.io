...
<p align="center">
<img width="1000" alt="1" src="https://github.com/meaningful96/Blogging/assets/111734605/e9ff7c5f-e5c2-49f3-9afa-580bb7781d9b">
</p>
...
<p align="center">
<img width="1000" alt="1" src="https://github.com/meaningful96/Blogging/assets/111734605/ecbc564a-3a89-495f-a461-8b32ef9c8448">
</p>
...
<p align="center">
<img width="1000" alt="1" src="https://github.com/meaningful96/Blogging/assets/111734605/9b7072eb-fcea-489c-99d2-78f2a1829e6e">
</p>
...
<p align="center">
<img width="1000" alt="1" src="https://github.com/meaningful96/Blogging/assets/111734605/a4a72737-e686-42d8-b9a8-52ed487d532e">
</p>

위에처럼 기존에는 Retriever-Reader를 중심으로 Open Domain QA문제를 푸는 것을 목표로 했다. RAG가 가지는 중요한 의미는 ODQA task를 KIT와 결합하여 확장했다는 것이다. RAG이전의 모델들은 간단하게 다음과 같은 문제를 가진다.

- **DrQA**: Retriever에 대한 training이 불가하여 passage 개선이 불가능하다.
- **ORQA**: Retriever를 학습하는 것이 가능하나 $$max P(a \vert p, q)P(p \vert q)$$ 형태로 분해하여 학습이 불가능하다.
- **REALM**: Retriever 업데이트 시 필요한 정보는 정답 추론 시 passage가 도움이 되는 정도이다. 이 때 완전히 $$max P(a \vert p, q)P(p \vert q)$$ 형태로 학습을 하진 못하고, $$\[ \frac{P(a \vert p,q)}{P(a \vert q) - 1}\]P(p \vert q)$$형태로 학습을 하게 된다.
