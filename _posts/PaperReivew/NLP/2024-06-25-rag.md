...
다시 말해 외부 지식이 있으면 ODQA의 정답에 대한 liklihood는 (i) <span style = "color:gold">**Passage의 확률분포**</span>와 (ii) <span style="color:red">**Answer에 대한 Passage의 liklihood**</span>로 분해되어 쉽게 풀 수 있다. 학습은 이 둘을 maximize하는 방향으로 진행하면 된다.
