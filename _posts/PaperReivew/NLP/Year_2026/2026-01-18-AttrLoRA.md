...
학습은 비교적 간단하다. 일반적인 instruction tuning방식이며, LLM이 <span style="color:red">**reasoning 시 citation을 생성하는 CoC chain을 직접 출력**</span>하도록 학습한다. 이 때, 앞서 만든 MuSiQue기반의 고품질 데이터셋을 **Learning to Attribute(LA)**라고 한다.
