...
Vision task에서는 MNIST, FashionMNIST, CIFAR-10, CIFAR-100, TinyImageNet, set anomaly detection을 평가한다. Stnthetic task와 마찬가지로 Vision task에서도 symmetric attention이 language modeling만큼 치명적이지 않으며, <span style="color:red">**Q=K-V나 Q=K=V도 QKV와 동등하거나 더 나은 성능**</span>을 보인다.
