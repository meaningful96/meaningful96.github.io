...
# Problem Statement
기존의 IR (Information Retrieval)모델들은 <span style="color:#9e0000">**매우 높은 컴퓨팅 자원을 요구**</span>하였으며, <span style="color:#9e0000">**coarse grain**</span>하다.
...
<span style="color:#9e0000">**Late Interaction**</span>의 의미는 다시 말해, 하나의 인코더로 쿼리와 문서를 임베딩하지만, 각각 독립적으로 임베딩해 attention을 계산하지 않고, **나중에 따로 유사도 연산을 진행**함을 의미한다.
