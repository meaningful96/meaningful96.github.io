...
JointGT의 Structure-Aware Semantic Encoder 모듈의 효과를 비교하기위해 기존에 존재하던 Sequence 인코더와 Relation-Aware 인코더를 대채하여 실험을 진행하였다. Evaluation Metric은 BLEU, METEOR, ROUGE 총 세 가지를 사용하여 진행했다.
