...
시간 복잡도는 <span style="color:#9e0000">**Worst Case에 대한 알고리즘의 수행시간**</span>을 나타낸다. 다음의 두 함수 `함수1`과 `함수2`를 비교해보자.
...
# 공간 복잡도
## 개념
공간 복잡도(Space Complexity)는 <span style="color:#9e0000">**알고리즘을 실행하는 동안 필요로 하는 메모리 공간의 양**</span>을 나타낸다. 이는 주로 다음 두 가지 요소로 구성된다.
